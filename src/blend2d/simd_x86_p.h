...
#if defined(BL_TARGET_OPT_SSE4_1)
BL_INLINE I128 vmuli32(const I128& x, const I128& y) noexcept { return _mm_mullo_epi32(x, y); }
BL_INLINE I128 vmulu32(const I128& x, const I128& y) noexcept { return _mm_mullo_epi32(x, y); }
#endif

BL_INLINE I128 vmaddi16i32(const I128& x, const I128& y) noexcept { return _mm_madd_epi16(x, y); }

template<uint8_t N_BITS> BL_INLINE I128 vslli16(const I128& x) noexcept { return N_BITS ? _mm_slli_epi16(x, N_BITS) : x; }
template<uint8_t N_BITS> BL_INLINE I128 vslli32(const I128& x) noexcept { return N_BITS ? _mm_slli_epi32(x, N_BITS) : x; }
template<uint8_t N_BITS> BL_INLINE I128 vslli64(const I128& x) noexcept { return N_BITS ? _mm_slli_epi64(x, N_BITS) : x; }

template<uint8_t N_BITS> BL_INLINE I128 vsrli16(const I128& x) noexcept { return N_BITS ? _mm_srli_epi16(x, N_BITS) : x; }
template<uint8_t N_BITS> BL_INLINE I128 vsrli32(const I128& x) noexcept { return N_BITS ? _mm_srli_epi32(x, N_BITS) : x; }
template<uint8_t N_BITS> BL_INLINE I128 vsrli64(const I128& x) noexcept { return N_BITS ? _mm_srli_epi64(x, N_BITS) : x; }

template<uint8_t N_BITS> BL_INLINE I128 vsrai16(const I128& x) noexcept { return N_BITS ? _mm_srai_epi16(x, N_BITS) : x; }
template<uint8_t N_BITS> BL_INLINE I128 vsrai32(const I128& x) noexcept { return N_BITS ? _mm_srai_epi32(x, N_BITS) : x; }

template<uint8_t N_BYTES> BL_INLINE I128 vslli128b(const I128& x) noexcept { return N_BYTES ? _mm_slli_si128(x, N_BYTES) : x; }
template<uint8_t N_BYTES> BL_INLINE I128 vsrli128b(const I128& x) noexcept { return N_BYTES ? _mm_srli_si128(x, N_BYTES) : x; }
...
#if defined(BL_TARGET_OPT_AVX2)
BL_INLINE I128 vloadi128_mask32(const void* p, const I128& mask) noexcept { return _mm_maskload_epi32(static_cast<const int*>(p), mask); }
BL_INLINE I128 vloadi128_mask64(const void* p, const I128& mask) noexcept { return _mm_maskload_epi64(static_cast<const long long*>(p), mask); }
#endif
...
#if defined(BL_TARGET_OPT_AVX2)
BL_INLINE void vstorei128_mask32(void* p, const I128& x, const I128& mask) noexcept { _mm_maskstore_epi32(static_cast<int*>(p), mask, x); }
BL_INLINE void vstorei128_mask64(void* p, const I128& x, const I128& mask) noexcept { _mm_maskstore_epi64(static_cast<long long*>(p), mask, x); }
#endif

#if defined(BL_TARGET_OPT_SSE4_1)
template<uint32_t I>
BL_INLINE I128 vinsertu8(const I128& x, uint32_t y) noexcept { return _mm_insert_epi8(x, int8_t(y), I); }
template<uint32_t I>
BL_INLINE I128 vinsertu16(const I128& x, uint32_t y) noexcept { return _mm_insert_epi16(x, int16_t(y), I); }
template<uint32_t I>
BL_INLINE I128 vinsertu32(const I128& x, uint32_t y) noexcept { return _mm_insert_epi32(x, int(y), I); }

template<uint32_t I>
BL_INLINE I128 vinsertm8(const I128& x, const void* p) noexcept { return _mm_insert_epi8(x, blMemReadU8(p), I); }
template<uint32_t I>
BL_INLINE I128 vinsertm16(const I128& x, const void* p) noexcept { return _mm_insert_epi16(x, blMemReadU16u(p), I); }
template<uint32_t I>
BL_INLINE I128 vinsertm32(const I128& x, const void* p) noexcept { return _mm_insert_epi32(x, blMemReadU32u(p), I); }

// Convenience function used by RGB24 fetchers.
template<uint32_t I>
BL_INLINE I128 vinsertm24(const I128& x, const void* p) noexcept {
...
template<uint32_t I>
BL_INLINE uint32_t vextractu8(const I128& x) noexcept { return uint32_t(_mm_extract_epi8(x, I)); }
template<uint32_t I>
BL_INLINE uint32_t vextractu16(const I128& x) noexcept { return uint32_t(_mm_extract_epi16(x, I)); }
template<uint32_t I>
BL_INLINE uint32_t vextractu32(const I128& x) noexcept { return uint32_t(_mm_extract_epi32(x, I)); }
#endif
...
#if defined(BL_TARGET_OPT_AVX)
BL_INLINE F128 vloadf128_mask32(const void* p, const F128& mask) noexcept { return _mm_maskload_ps(static_cast<const float*>(p), vcast<I128>(mask)); }
#endif
...
#if defined(BL_TARGET_OPT_AVX)
BL_INLINE void vstoref128_mask32(void* p, const F128& x, const F128& mask) noexcept { _mm_maskstore_ps(static_cast<float*>(p), vcast<I128>(mask), x); }
#endif
...
#if defined(BL_TARGET_OPT_AVX)
BL_INLINE D128 vloadd128_mask64(const void* p, const D128& mask) noexcept { return _mm_maskload_pd(static_cast<const double*>(p), vcast<I128>(mask)); }
#endif
...
#if defined(BL_TARGET_OPT_AVX)
BL_INLINE void vstored128_mask64(void* p, const D128& x, const D128& mask) noexcept { _mm_maskstore_pd(static_cast<double*>(p), vcast<I128>(mask), x); }
#endif
...
BL_INLINE I256 vunpackli128(const I256& x, const I256& y) noexcept { return vpermi128<2, 0>(x, y); }
BL_INLINE I256 vunpackhi128(const I256& x, const I256& y) noexcept { return vpermi128<3, 1>(x, y); }
...
BL_INLINE I256 vmuli32(const I256& x, const I256& y) noexcept { return _mm256_mullo_epi32(x, y); }
BL_INLINE I256 vmulu32(const I256& x, const I256& y) noexcept { return _mm256_mullo_epi32(x, y); }

BL_INLINE I256 vmaddi16i32(const I256& x, const I256& y) noexcept { return _mm256_madd_epi16(x, y); }

template<uint8_t N_BITS> BL_INLINE I256 vslli16(const I256& x) noexcept { return N_BITS ? _mm256_slli_epi16(x, N_BITS) : x; }
template<uint8_t N_BITS> BL_INLINE I256 vslli32(const I256& x) noexcept { return N_BITS ? _mm256_slli_epi32(x, N_BITS) : x; }
template<uint8_t N_BITS> BL_INLINE I256 vslli64(const I256& x) noexcept { return N_BITS ? _mm256_slli_epi64(x, N_BITS) : x; }

template<uint8_t N_BITS> BL_INLINE I256 vsrli16(const I256& x) noexcept { return N_BITS ? _mm256_srli_epi16(x, N_BITS) : x; }
template<uint8_t N_BITS> BL_INLINE I256 vsrli32(const I256& x) noexcept { return N_BITS ? _mm256_srli_epi32(x, N_BITS) : x; }
template<uint8_t N_BITS> BL_INLINE I256 vsrli64(const I256& x) noexcept { return N_BITS ? _mm256_srli_epi64(x, N_BITS) : x; }

template<uint8_t N_BITS> BL_INLINE I256 vsrai16(const I256& x) noexcept { return N_BITS ? _mm256_srai_epi16(x, N_BITS) : x; }
template<uint8_t N_BITS> BL_INLINE I256 vsrai32(const I256& x) noexcept { return N_BITS ? _mm256_srai_epi32(x, N_BITS) : x; }

template<uint8_t N_BYTES> BL_INLINE I256 vslli128b(const I256& x) noexcept { return N_BYTES ? _mm256_slli_si256(x, N_BYTES) : x; }
template<uint8_t N_BYTES> BL_INLINE I256 vsrli128b(const I256& x) noexcept { return N_BYTES ? _mm256_srli_si256(x, N_BYTES) : x; }
...
BL_INLINE I256 vloadi256_mask32(const void* p, const I256& mask) noexcept { return _mm256_maskload_epi32(static_cast<const int*>(p), mask); }
BL_INLINE I256 vloadi256_mask64(const void* p, const I256& mask) noexcept { return _mm256_maskload_epi64(static_cast<const long long*>(p), mask); }
...
template<uint32_t I>
BL_INLINE I256 vinsertu8(const I256& x, uint32_t y) noexcept { return _mm256_insert_epi8(x, int8_t(y), I); }
template<uint32_t I>
BL_INLINE I256 vinsertu16(const I256& x, uint32_t y) noexcept { return _mm256_insert_epi16(x, int16_t(y), I); }
template<uint32_t I>
BL_INLINE I256 vinsertu32(const I256& x, uint32_t y) noexcept { return _mm256_insert_epi32(x, y, I); }

template<uint32_t I>
BL_INLINE I256 vinsertum8(const I256& x, const void* p) noexcept { return _mm256_insert_epi8(x, blMemReadU8(p), I); }
template<uint32_t I>
BL_INLINE I256 vinsertum16(const I256& x, const void* p) noexcept { return _mm256_insert_epi16(x, blMemReadU16u(p), I); }
template<uint32_t I>
BL_INLINE I256 vinsertum32(const I256& x, const void* p) noexcept { return _mm256_insert_epi32(x, blMemReadU32u(p), I); }

template<uint32_t I>
BL_INLINE uint32_t vextractu8(const I256& x) noexcept { return uint32_t(_mm256_extract_epi8(x, I)); }
template<uint32_t I>
BL_INLINE uint32_t vextractu16(const I256& x) noexcept { return uint32_t(_mm256_extract_epi16(x, I)); }
template<uint32_t I>
BL_INLINE uint32_t vextractu32(const I256& x) noexcept { return uint32_t(_mm256_extract_epi32(x, I)); }
...
BL_INLINE void vstorei256_mask32(void* p, const I256& x, const I256& mask) noexcept { _mm256_maskstore_epi32(static_cast<int*>(p), mask, x); }
BL_INLINE void vstorei256_mask64(void* p, const I256& x, const I256& mask) noexcept { _mm256_maskstore_epi64(static_cast<long long*>(p), mask, x); }
...
BL_INLINE F256 vloadf256_mask32(const void* p, const F256& mask) noexcept { return _mm256_maskload_ps(static_cast<const float*>(p), vcast<I256>(mask)); }
...
BL_INLINE void vstoref256_mask32(void* p, const F256& x, const F256& mask) noexcept { _mm256_maskstore_ps(static_cast<float*>(p), vcast<I256>(mask), x); }
...
BL_INLINE D256 vloadd256_mask64(const void* p, const D256& mask) noexcept { return _mm256_maskload_pd(static_cast<const double*>(p), vcast<I256>(mask)); }
...
BL_INLINE void vstored256_mask64(void* p, const D256& x, const D256& mask) noexcept { _mm256_maskstore_pd(static_cast<double*>(p), vcast<I256>(mask), x); }
