...
UNIT(support_intops_alignment, BL_TEST_GROUP_SUPPORT_UTILITIES) {
  ...
  INFO("Testing BLIntOps::isPowerOf2()");
  {
  ...
  INFO("Testing BLIntOps::alignUpDiff()");
  {
  ...
  INFO("Testing BLIntOps::alignUpPowerOf2()");
  {
...
UNIT(support_intops_arithmetic, BL_TEST_GROUP_SUPPORT_UTILITIES) {
  INFO("Testing BLIntOps::addOverflow()");
  {
    BLOverflowFlag of = 0;
  ...
  INFO("Testing BLIntOps::subOverflow()");
  {
    BLOverflowFlag of = 0;
  ...
  INFO("Testing BLIntOps::mulOverflow()");
  {
    BLOverflowFlag of = 0;
...
UNIT(support_intops_bit_manipulation, BL_TEST_GROUP_SUPPORT_UTILITIES) {
  ...
  INFO("Testing BLIntOps::shl() / BLIntOps::shr()");
  ...
  INFO("Testing BLIntOps::rol() / BLIntOps::ror()");
  ...
  INFO("Testing BLIntOps::isBitMaskConsecutive()");
  i = 0;
  for (;;) {
...
UNIT(support_intops_byteswap, BL_TEST_GROUP_SUPPORT_UTILITIES) {
  ...
  INFO("Testing BLIntOps::byteSwap32()");
  ...
  INFO("Testing BLIntOps::byteSwap64()");
...
UNIT(support_intops_clamp, BL_TEST_GROUP_SUPPORT_UTILITIES) {
  ...
  INFO("Testing BLIntOps::clampToByte()");
  {
  ...
  INFO("Testing BLIntOps::clampToWord()");
  {
...
UNIT(support_intops_popcnt, BL_TEST_GROUP_SUPPORT_UTILITIES) {
  INFO("Testing BLIntOps::PopCounter<uint32_t>");
