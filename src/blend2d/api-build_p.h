...
enum BLTestGroup : int {
  ...
  BL_TEST_GROUP_TEXT_COMBINED = 14,
  BL_TEST_GROUP_RENDERING_PIXEL_OPS = 15,
  BL_TEST_GROUP_RENDERING_UTILITIES = 16,
  BL_TEST_GROUP_RENDERING_STYLES = 17,
  BL_TEST_GROUP_RENDERING_CONTEXT = 18
};
//! \endcond
